...
--  escribir ":q" (quit) para salir del intérprete.
--  :l ['nombre del archivo'.hs] (load)
--  :r (reload) para recargar un archivo que ya había sido interpretado, usar luego de modificar un .hs y antes de ejecutar.
